...
Plug 'rcarriga/nvim-notify' " message UI
...
Plug 'debugloop/telescope-undo.nvim' " telescope extension: undo history
Plug 'AckslD/nvim-neoclip.lua' " telescope extension: clipboard history
" lsp config
...
nnoremap <silent><leader>y <cmd>Telescope find_files<cr>
nnoremap <silent><leader>u <cmd>Telescope undo<cr>
nnoremap <silent><leader>p <cmd>Telescope neoclip<cr>
...
lua require("noice").setup{messages={view="mini",view_error="notify",view_warn="notify"},lsp={signature={enabled=false}}}
